    ...
    return (
        ...
        ${selectedUser ? "max-md:hidden" : ''}`}>
            ...
            <div className='flex flex-col'>
                ...
                <div
                    onClick={() => {
                        setSelectedUser({ isAI: true, fullName: "AI Chatbot", _id: "ai_chatbot" });
                        setUnseenMessages(prev => ({ ...prev, ai_chatbot: 0 }));
                    }}
                    className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer
                        max-sm:text-sm ${selectedUser?.isAI && 'bg-[#282142]/50'}`}
                    style={{ cursor: "pointer" }}
                >
                    <img
                        src={assets.robot_icon || assets.avatar_icon}
                        alt="AI Chatbot"
