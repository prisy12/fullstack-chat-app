...
const LoginPage = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    // Step 1 of signup: validate name, email, password before showing bio
    ...
    // Final submission (login or full signup)
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      <img src={assets.logo_big} className='w-[120px] sm:w-[150px] md:w-[180px]' alt="" />

      <form onSubmit={onSubmitHandler} className='border-2 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
